...
export default function PharmacyAuthScreen({ onLogin, isLoading, error }: PharmacyAuthScreenProps) {
  ...
  return (
    <>
      ...
      <div className="pharmacy-auth-bg" dir="rtl">
        <div className="auth-card">
          ...
          <div style={{
            ...
            <i className="fa-solid fa-shield-halved" style={{ color: '#10b981', fontSize: '1rem' }} />
            <p style={{ color: '#6ee7b7', fontSize: '0.8125rem', margin: 0, lineHeight: 1.4 }}>
              عزل البيانات — الصيدلي يرى الأدوية فقط
            </p>
          </div>
            ...
            <div>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  type="text"
                  dir="ltr"
                  placeholder="أدخل الرقم الوطني للصيدلي"
                  value={nin}
          ...
          <p style={{ textAlign: 'center', color: 'rgba(148,163,184,0.5)', fontSize: '0.75rem', marginTop: '1.5rem' }}>
            بوابة مخصصة للصيادلة المرخصين فقط
          </p>
        </div>
      </div>
    </>
